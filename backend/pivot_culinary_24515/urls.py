"""pivot_culinary_24515 URL Configuration
...
admin.site.site_header = "PIVOT CULINARY"
admin.site.site_title = "PIVOT CULINARY Admin Portal"
admin.site.index_title = "PIVOT CULINARY Admin"

# swagger
api_info = openapi.Info(
    title="PIVOT CULINARY API",
    default_version="v1",
    description="API documentation for PIVOT CULINARY App",
)
